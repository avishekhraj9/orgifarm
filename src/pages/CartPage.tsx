      ...
      <div className="max-w-4xl mx-auto">
        ...
        {items.length === 0 ? (
          <div className="text-center py-12">
            <div className="bg-secondary/50 dark:bg-secondary/30 p-8 rounded-lg">
          ...
          <>
            <div className="bg-white dark:bg-card rounded-lg shadow-sm border border-border overflow-hidden mb-8">
              <div className="hidden md:grid grid-cols-12 gap-4 p-4 font-medium text-sm bg-secondary/40 dark:bg-secondary/20">
                    ...
                    <div className="col-span-6 flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <Link 
                          ...
                          className="font-medium text-lg mb-1 hover:text-primary transition-colors line-clamp-1 dark:text-gray-200"
                        >
                          {item.product.name}
                        </Link>
                        <button 
                          onClick={() => removeFromCart(item.product.id)}
                          className="flex items-center text-sm text-red-500 hover:text-red-700 transition-colors dark:text-red-400 dark:hover:text-red-300"
                        >
